...
class Widget(QWidget):
    ...
    # firstly we must check the type of the extension to know where to save the written code
        if(extensionType=="py"):#file is python
            with open('main.py', 'w') as f:
                TEXT = text.toPlainText()
                f.write(TEXT)
                
               
        elif(extensionType=="cs"): #file is csharp
...
#        Port.addAction(Port_Action)
        ...
        Python_Action.triggered.connect(self.pyhonSelected)
        CSharp_Action=QAction("C#",self)
        CSharp_Action.triggered.connect(self.CSharpSelected)
...
#            ide.upload_file(self.portNo)
    ...
    def CSharpSelected(self):
       global extensionType 
       extensionType="cs" 
       CSharp_Coloring.CSharpHighlighter(text)
       
    def pyhonSelected(self):
       global extensionType 
       extensionType="py" 
       Python_Coloring.PythonHighlighter(text)
